      ...
      if (this.validate()) {
        return HandOverDialogUtil.loadHandOverDialogData({
          ...
          return function(reservations, purpose) {
            return new App.HandOverDialogController(reservations, _this.user, purpose, function() {
              return _this.lineSelection.clearLocalStorage();
            });
          };
        })(this));
      } else {
...
(function() {
  ...
  window.App.HandOverDialogController = (function(superClass) {
    ...
    function HandOverDialogController(reservations, user, purpose, callback) {
...
(function() {
  ...
  window.App.LineSelectionController = (function(superClass) {
    ...
    function LineSelectionController() {
      ...
      this.localStorageEnabled = bind(this.localStorageEnabled, this);
      ...
      this.localStorageKey = bind(this.localStorageKey, this);
      this.clearLocalStorage = bind(this.clearLocalStorage, this);
      this.restoreSelectionFromLocalStorage = bind(this.restoreSelectionFromLocalStorage, this);
      this.delegateEvents = bind(this.delegateEvents, this);
    ...
    LineSelectionController.prototype.restoreSelectionFromLocalStorage = function() {
      var idsStringified, localStorageIds, presentIds;
      if (this.localStorageEnabled()) {
        if (idsStringified = localStorage.getItem(this.localStorageKey())) {
          localStorageIds = JSON.parse(idsStringified);
          presentIds = this.extractIds(this.lines());
    ...
    LineSelectionController.prototype.clearLocalStorage = function() {
      return localStorage.removeItem(this.localStorageKey());
    };

    LineSelectionController.prototype.localStorageKey = function() {
      return "leihs_" + this.visitType + "_" + this.user.id;
    };
    ...
    LineSelectionController.prototype.selectedLines = function() {
      return $("[data-select-line]:checked").closest(".line");
    };

    LineSelectionController.prototype.lines = function() {
      return $("[data-id]");
    };

    LineSelectionController.prototype.getDataIds = function(line) {
      var ref;
      return (ref = $(line).data("ids")) != null ? ref : [$(line).data("id")];
    };

    LineSelectionController.prototype.extractIds = function(rLines) {
      return _.flatten(_.map(rLines, (function(_this) {
        return function(line) {
          return _this.getDataIds(line);
        };
      })(this)));
    };

    LineSelectionController.prototype.localStorageEnabled = function() {
      return _.includes(["handOver", "takeBack"], this.visitType);
    };

    LineSelectionController.prototype.update = function() {
      var rLines, ref;
      rLines = this.selectedLines();
      this.store(rLines);
      if (this.localStorageEnabled()) {
        this.storeToLocalStorage(rLines);
      }
      if ((ref = this.markVisitLinesController) != null) {
        ref.update(App.LineSelectionController.selected);
      }
      this.lineSelectionCounter.html(rLines.length);
      if (rLines.length) {
        this.enable();
      } else {
        this.disable();
    ...
    LineSelectionController.prototype.store = function(rLines) {
      var ids;
      ids = this.extractIds(rLines);
      return App.LineSelectionController.selected = ids;
    };

    LineSelectionController.prototype.storeToLocalStorage = function(rLines) {
      var ids;
      ids = this.extractIds(rLines);
      return localStorage.setItem(this.localStorageKey(this.user.id), JSON.stringify(ids));
    };

    LineSelectionController.prototype.restore = function() {
      var ids, input, j, len, line, ref, ref1;
      ref = $("[data-select-line]");
      for (j = 0, len = ref.length; j < len; j++) {
        input = ref[j];
        input = $(input);
        line = input.closest(".line");
        ids = this.getDataIds(line);
      ...
      if ((ref1 = this.markVisitLinesController) != null) {
